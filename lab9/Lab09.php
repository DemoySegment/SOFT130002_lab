...
<body>
    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
            ...
            foreach($countries as $country){
               ...
               // echo' <a href="list.php?country=';
                //echo "$country";
                //echo'" role="button" class="btn btn-default">  ';
                //echo"$country";
                //echo'</a>';
            }
   ...
   //              </a>
            ...
            foreach($images as $keys){
               echo"<li>";
               echo' <a href="detail.php?id='.$keys["id"].'" class="img-responsive">';
               echo'<img src="images/square/'.$keys["path"].'" alt="'.$keys["title"].'">';
               echo	'<div class="caption">
                           		<div class="blur">
                            		</div>
                                <div class="caption-text">';
                                echo '<h1>'.$keys["title"].'</h1>';
                                echo"</div>
                                           	</div>
                                             </a>
                                          </li>";
